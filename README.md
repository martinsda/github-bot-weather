...
## Currently
`Lisbon, Portugal - 2024-11-14 19:19:29`
...
<table>
    ...
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0 mm</td><td width="200px">0 mm</td><td width="200px">1 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Light Showers</td><td>Cloudy</td><td>Mainly Clear</td>
    </tr>
    <tr>
        <th>Weather</th>
        <td><img src="http://openweathermap.org/img/wn/09d@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/03n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/01n@2x.png"/></td>
    </tr>
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0 mm</td><td width="200px">0 mm</td><td width="200px">0 mm</td>
