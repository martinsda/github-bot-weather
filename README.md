...
## Currently
`Lisbon, Portugal - 2026-01-28 09:44:40`
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Light Rain</td><td>Heavy Drizzle</td><td>Cloudy</td>
    </tr>
    <tr>
        <th>Weather</th>
    ...
    <tr>
        <th>Rain forecast</th>
        <td width="200px">1.6 mm</td><td width="200px">1.2 mm</td><td width="200px">0.0 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
        <td>93%</td><td>83%</td><td>68%</td>
    </tr>
</table>
