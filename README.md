...
## Currently
`Lisbon, Portugal - 2025-04-12 20:20:04`
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Thunderstorm</td><td>Thunderstorm</td><td>Showers</td>
    </tr>
    <tr>
        <th>Weather</th>
    ...
    <tr>
        <th>Rain forecast</th>
        <td width="200px">2.2 mm</td><td width="200px">0.8 mm</td><td width="200px">1.9 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
...
<table>
    ...
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0.0 mm</td><td width="200px">0.2 mm</td><td width="200px">0.5 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Thunderstorm</td><td>Showers</td><td>Light Showers</td>
    </tr>
    <tr>
        <th>Weather</th>
    ...
    <tr>
        <th>Rain forecast</th>
        <td width="200px">1.2 mm</td><td width="200px">1.9 mm</td><td width="200px">0.4 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
