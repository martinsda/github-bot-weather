...
## Currently
`Lisbon, Portugal - 2025-11-03 08:38:46`
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Cloudy</td><td>Mainly Clear</td><td>Cloudy</td>
    </tr>
    <tr>
        <th>Weather</th>
        <td><img src="http://openweathermap.org/img/wn/03n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/01n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/03n@2x.png"/></td>
    </tr>
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0.0 mm</td><td width="200px">0.0 mm</td><td width="200px">0.0 mm</td>
