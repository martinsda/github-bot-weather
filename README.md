...
## Currently
`Lisbon, Portugal - 2025-03-11 19:22:04`
...
<table>
    ...
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0.2 mm</td><td width="200px">0.7 mm</td><td width="200px">0.5 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
        <td>35%</td><td>58%</td><td>58%</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Partly Cloudy</td><td>Mainly Sunny</td><td>Mainly Sunny</td>
    </tr>
    <tr>
        <th>Weather</th>
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Partly Cloudy</td><td>Mainly Clear</td><td>Clear</td>
    </tr>
    <tr>
        <th>Weather</th>
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Clear</td><td>Mainly Clear</td><td>Cloudy</td>
    </tr>
    <tr>
        <th>Weather</th>
        <td><img src="http://openweathermap.org/img/wn/01n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/01n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/03n@2x.png"/></td>
    </tr>
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0.0 mm</td><td width="200px">0.0 mm</td><td width="200px">0.0 mm</td>
