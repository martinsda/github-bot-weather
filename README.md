...
## Currently
`Lisbon, Portugal - 2026-05-08 18:40:24`
...
<table>
    ...
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0.1 mm</td><td width="200px">0.2 mm</td><td width="200px">1.0 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
        <td>73%</td><td>73%</td><td>93%</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <th>Weather</th>
        <td><img src="http://openweathermap.org/img/wn/10n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/09n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/09n@2x.png"/></td>
    </tr>
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0.5 mm</td><td width="200px">0.6 mm</td><td width="200px">0.8 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
        <td>90%</td><td>95%</td><td>98%</td>
    </tr>
</table>
