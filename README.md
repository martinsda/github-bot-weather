...
## Currently
`Lisbon, Portugal - 2026-02-02 10:02:34`
...
<table>
    ...
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0.2 mm</td><td width="200px">0.4 mm</td><td width="200px">0.1 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
        <td>65%</td><td>70%</td><td>85%</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Light Showers</td><td>Partly Cloudy</td><td>Thunderstorm</td>
    </tr>
    <tr>
        <th>Weather</th>
        <td><img src="http://openweathermap.org/img/wn/09d@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/02n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/11n@2x.png"/></td>
    </tr>
    <tr>
        <th>Rain forecast</th>
        <td width="200px">0.4 mm</td><td width="200px">0.0 mm</td><td width="200px">0.9 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
