...
## Currently
`Lisbon, Portugal - 2025-02-15 12:42:06`
...
<table>
    ...
    <tr>
        <th>Conditions</th>
        <td>Light Rain</td><td>Light Rain</td><td>Mainly Clear</td>
    </tr>
    <tr>
        <th>Weather</th>
        <td><img src="http://openweathermap.org/img/wn/10n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/10n@2x.png"/></td><td><img src="http://openweathermap.org/img/wn/01n@2x.png"/></td>
    </tr>
    <tr>
        <th>Rain forecast</th>
        <td width="200px">1.0 mm</td><td width="200px">0.2 mm</td><td width="200px">0.0 mm</td>
    </tr>
    <tr>
        <th>Rain probability</th>
