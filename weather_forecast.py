...
def get_forecast_weather(lat, long):
	...
	params = {
		"latitude": lat,
		"longitude": long,
		"daily": ["temperature_2m_max", "temperature_2m_min", "sunrise", "sunset", "rain_sum", "wind_speed_10m_max", "wind_gusts_10m_max", "wind_direction_10m_dominant"]
	}
...
def main():
    ...
    if city_lat:
        ...
        if city_long:
            ...
            set_action_output('wind_speed_10m_0', "Wind: " + str(int(daily_dataframe.wind_speed_10m_max[0])) +">"+ str(int(daily_dataframe.wind_gusts_10m_max[0])) +" km/h " + str(round(float(daily_dataframe.wind_direction_10m_dominant[0]))) +"º")
            ...
            set_action_output('wind_speed_10m_1', "Wind: " + str(int(daily_dataframe.wind_speed_10m_max[1])) +">"+str(int(daily_dataframe.wind_gusts_10m_max[1])) +" km/h" + str(round(float(daily_dataframe.wind_direction_10m_dominant[1])))+"º")
            ...
            set_action_output('wind_speed_10m_2', "Wind: " + str(int(daily_dataframe.wind_speed_10m_max[2])) +">"+str(int(daily_dataframe.wind_gusts_10m_max[2])) +" km/h" + str(round(float(daily_dataframe.wind_direction_10m_dominant[2])))+"º")
            ...
            set_action_output('wind_speed_10m_3', "Wind: " + str(int(daily_dataframe.wind_speed_10m_max[3])) +">"+str(int(daily_dataframe.wind_gusts_10m_max[3])) +" km/h" + str(round(float(daily_dataframe.wind_direction_10m_dominant[3])))+"º")
            ...
            set_action_output('wind_speed_10m_4', "Wind: " + str(int(daily_dataframe.wind_speed_10m_max[4])) +">"+str(int(daily_dataframe.wind_gusts_10m_max[4])) +" km/h" + str(round(float(daily_dataframe.wind_direction_10m_dominant[4])))+"º")
            ...
            set_action_output('wind_speed_10m_5', "Wind: " + str(int(daily_dataframe.wind_speed_10m_max[5])) +">"+str(int(daily_dataframe.wind_gusts_10m_max[5])) +" km/h" + str(round(float(daily_dataframe.wind_direction_10m_dominant[5])))+"º")
        else:
