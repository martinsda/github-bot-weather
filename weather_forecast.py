...
def main():
    ...
    if city_lat:
        ...
        if city_long:
            ...
            set_action_output('wind_speed_10m_0', "Wind: " + int(daily_dataframe.wind_speed_10m_max[0]) +">"+int(daily_dataframe.wind_gusts_10m_max[0]) +" km/h" +daily_dataframe.wind_direction_10m_dominant[0]+"º")
            ...
            set_action_output('wind_speed_10m_1', "Wind: " + int(daily_dataframe.wind_speed_10m_max[1]) +">"+int(daily_dataframe.wind_gusts_10m_max[1]) +" km/h" +daily_dataframe.wind_direction_10m_dominant[1]+"º")
            ...
            set_action_output('wind_speed_10m_2', "Wind: " + int(daily_dataframe.wind_speed_10m_max[2]) +">"+int(daily_dataframe.wind_gusts_10m_max[2]) +" km/h" +daily_dataframe.wind_direction_10m_dominant[2]+"º")
            ...
            set_action_output('wind_speed_10m_3', "Wind: " + int(daily_dataframe.wind_speed_10m_max[3]) +">"+int(daily_dataframe.wind_gusts_10m_max[3]) +" km/h" +daily_dataframe.wind_direction_10m_dominant[3]+"º")
            ...
            set_action_output('wind_speed_10m_4', "Wind: " + int(daily_dataframe.wind_speed_10m_max[4]) +">"+int(daily_dataframe.wind_gusts_10m_max[4]) +" km/h" +daily_dataframe.wind_direction_10m_dominant[4]+"º")
            ...
            set_action_output('wind_speed_10m_5', "Wind: " + int(daily_dataframe.wind_speed_10m_max[5]) +">"+int(daily_dataframe.wind_gusts_10m_max[5]) +" km/h" +daily_dataframe.wind_direction_10m_dominant[5]+"º")
        else:
