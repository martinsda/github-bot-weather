...
def get_forecast_weather(lat, long):
 ...
 "precipitation_probability": [
    ...
    "precipitation": [
		hourly_dataframe.precipitation[0],
        hourly_dataframe.precipitation[1], 
        hourly_dataframe.precipitation[2], 
        hourly_dataframe.precipitation[3], 
        hourly_dataframe.precipitation[4], 
        hourly_dataframe.precipitation[5], 
        hourly_dataframe.precipitation[6], 
        hourly_dataframe.precipitation[7], 
        hourly_dataframe.precipitation[8], 
        hourly_dataframe.precipitation[8], 
        hourly_dataframe.precipitation[10], 
        hourly_dataframe.precipitation[11], 
        hourly_dataframe.precipitation[12], 
        hourly_dataframe.precipitation[13], 
        hourly_dataframe.precipitation[14], 
        hourly_dataframe.precipitation[15], 
        hourly_dataframe.precipitation[16], 
        hourly_dataframe.precipitation[17], 
        hourly_dataframe.precipitation[18], 
        hourly_dataframe.precipitation[19], 
        hourly_dataframe.precipitation[20], 
        hourly_dataframe.precipitation[21], 
        hourly_dataframe.precipitation[22], 
        hourly_dataframe.precipitation[23]],
    "weather_code": [
