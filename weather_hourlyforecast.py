...
def get_forecast_weather(lat, long):
  ...
  json_data = {
	...
	int(hourly_dataframe.precipitation_probability[0]), 
	int(hourly_dataframe.precipitation_probability[3]), 
	int(hourly_dataframe.precipitation_probability[1]), 
	int(hourly_dataframe.precipitation_probability[5]), 
	int(hourly_dataframe.precipitation_probability[6]), 
	int(hourly_dataframe.precipitation_probability[4]), 
	int(hourly_dataframe.precipitation_probability[2]), 
	int(hourly_dataframe.precipitation_probability[7]), 
	int(hourly_dataframe.precipitation_probability[8]), 
	int(hourly_dataframe.precipitation_probability[8]), 
	int(hourly_dataframe.precipitation_probability[10]), 
	int(hourly_dataframe.precipitation_probability[11]), 
	int(hourly_dataframe.precipitation_probability[12]), 
	int(hourly_dataframe.precipitation_probability[13]), 
	int(hourly_dataframe.precipitation_probability[14]), 
	int(hourly_dataframe.precipitation_probability[15]), 
	int(hourly_dataframe.precipitation_probability[16]), 
	int(hourly_dataframe.precipitation_probability[17]), 
	int(hourly_dataframe.precipitation_probability[18]), 
	int(hourly_dataframe.precipitation_probability[19]), 
	int(hourly_dataframe.precipitation_probability[20]), 
	int(hourly_dataframe.precipitation_probability[21]), 
	int(hourly_dataframe.precipitation_probability[22]), 
	int(hourly_dataframe.precipitation_probability[23])],
    "precipitation": [
    ...
    "weather_code": [
	str(hourly_dataframe.weather_code[0]), 
        str(hourly_dataframe.weather_code[1]), 
        str(hourly_dataframe.weather_code[2]), 
        str(hourly_dataframe.weather_code[3]), 
        str(hourly_dataframe.weather_code[4]), 
        str(hourly_dataframe.weather_code[5]), 
        str(hourly_dataframe.weather_code[6]), 
        str(hourly_dataframe.weather_code[7]), 
        str(hourly_dataframe.weather_code[8]), 
        str(hourly_dataframe.weather_code[8]), 
        str(hourly_dataframe.weather_code[10]), 
        str(hourly_dataframe.weather_code[11]), 
        str(hourly_dataframe.weather_code[12]), 
        str(hourly_dataframe.weather_code[13]), 
        str(hourly_dataframe.weather_code[14]), 
        str(hourly_dataframe.weather_code[15]), 
        str(hourly_dataframe.weather_code[16]), 
        str(hourly_dataframe.weather_code[17]), 
        str(hourly_dataframe.weather_code[18]), 
        str(hourly_dataframe.weather_code[19]), 
        str(hourly_dataframe.weather_code[20]), 
        str(hourly_dataframe.weather_code[21]), 
        str(hourly_dataframe.weather_code[22]), 
        str(hourly_dataframe.weather_code[23])],
